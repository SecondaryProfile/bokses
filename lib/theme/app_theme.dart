...
class ThemePreset {
  ...
  final Color accent;
  const ThemePreset(
      {required this.name, required this.primary, required this.accent});
}
...
class AppTheme {
  ...
  static const presets = [
    ThemePreset(
        name: 'BoksOtter',
        primary: Color(0xFF3A7BF7),
        accent: Color(0xFFE8394A)),
    ThemePreset(
        name: 'Moonlight Jelly',
        primary: Color(0xFF5C6BC0),
        accent: Color(0xFF26C6DA)),
    ThemePreset(
        name: 'Plant Pond',
        primary: Color(0xFF27AE60),
        accent: Color(0xFFF4A223)),
    ThemePreset(
        name: 'Ginger', primary: Color(0xFFFF6B35), accent: Color(0xFF9B59B6)),
    ThemePreset(
        name: 'Sweet Devil',
    ...
    ThemePreset(
        name: 'Creator', primary: Color(0xFF7C3AED), accent: Color(0xFF10B981)),
    ThemePreset(
        name: 'Robin', primary: Color(0xFF546E7A), accent: Color(0xFFFF7043)),
  ];
  ...
  static Color _bgTint(Color c, {double t = 0.07}) =>
      Color.lerp(_darkBase, c, t)!;
  static Color _sfTint(Color c, {double t = 0.06}) =>
      Color.lerp(_darkSurf, c, t)!;
  static Color _cdTint(Color c, {double t = 0.06}) =>
      Color.lerp(_darkCard, c, t)!;
  static Color _bgTintL(Color c, {double t = 0.05}) =>
      Color.lerp(_lightBase, c, t)!;
  static Color _sfTintL(Color c, {double t = 0.04}) =>
      Color.lerp(_lightSurf, c, t)!;
  static Color _cdTintL(Color c, {double t = 0.05}) =>
      Color.lerp(_lightCard, c, t)!;
  ...
  static Color get background =>
      _isDark ? _bgTint(boksBlue) : _bgTintL(boksBlue);
  ...
  static Color get textDark =>
      _isDark ? const Color(0xFFE8EEF8) : const Color(0xFF1A2240);
  static Color get textMid =>
      _isDark ? const Color(0xFF7A90B8) : const Color(0xFF5A6A8A);
  static Color get bubblePurple =>
      _isDark ? _cdTint(boksBlue, t: 0.14) : _cdTintL(boksBlue, t: 0.12);
  static Color get boksBlueLight =>
      _isDark ? _tintDark(boksBlue) : _tintLight(boksBlue);
  static Color get boksRedLight =>
      _isDark ? _tintDark(boksRed) : _tintLight(boksRed);
  ...
  static ThemeData _build({required bool dark}) {
    ...
    final border =
        dark ? _cdTint(primary, t: 0.14) : _cdTintL(primary, t: 0.12);
